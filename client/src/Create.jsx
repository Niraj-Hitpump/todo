...
const Create = ({ setTodos, todos }) => {
    ...
    const handleAdd = () => {
        ...
        axios
            .post("https://todopiche.vercel.app/add", { task: truncatedTask })
            .then((res) => {
    ...
    const handleDelete = (id) => {
        ...
        axios
            .delete(`https://todopiche.vercel.app/delete/${id}`)
            .then((res) => {
                if (res.status === 200) {
                    setTodos((prevTodos) =>
 ...
 const handleUpdate = (id) => {
    ...
    setLoading(true);
    axios
        .put(`https://todopiche.vercel.app/update/${id}`, { task, done: false })
        .then((res) => {
            setTodos((prevTodos) =>
                prevTodos.map((todo) =>
